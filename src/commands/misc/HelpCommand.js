...
class HelpCommand extends Command {
  ...
  run(message) {
    ...
    const embed = new MessageEmbed()
      .setTitle('Bảng trợ giúp ICE help')
    ...
    embed.addField('Phát hiện một lỗi?', `Bot này vẫn có thể xảy ra lỗi, vì vậy trong trường hợp bạn tìm thấy một lỗi, vui lòng báo cáo nó trong bot này [**Server ICE**](${MESSAGE_EMBED.helpURL}).`);
